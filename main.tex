...
\begin{spacing}{1.0}
	\textbf{Abstrakt:}	
	Cílem této práce je komparace současné francouzské a české mateřské školy ve vybraných aspektech. Těmi jsou cíle a pojetí předškolního vzdělávání a režim dne jedné třídy mateřské školy běžného dne. 
	Práce má dvě části, teoretickou a empirickou. 
	V teoretické části je zakotvení mateřských škol ve vzdělávacím systému, pojetí dítěte, podmínky péče o předškolní děti a důkladná analýza a srovnání legislativních dokumentů vzdělávání Francie a České republiky, včetně překladu vybraných částí kurikula z francouzského originálu. Empirická část je založena na pozorování a srovnání průběhu dne a podmínek, v nichž probíhá předškolní vzdělávání. Komparace sledovaných aspektů ukazuje rozdíly v pohledu na dítě a v aplikování teoretických dokumentů do praxe jak ve Francii, tak v České republice. 
