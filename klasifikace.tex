...
\end{itemize}
		...
		\textit{\begin{enumerate}[1)]
			...
			\item Oba modely}
		\end{enumerate}}
		%TODO: co to je? Osamela citace ceho?
		\citep{Prucha99}
...
% TODO: Odbarvi si text nebo to cele smaz, jak chces.
...
%TODO JA principy
	...
	\section{Mateřské školy v~České republice}
		...
		% TODO: Odbarvit text a nebo to smaz jestli se ti to nelibi.
...
\end{spacing}
		...
		Organizačně se mateřská škola dělí na třídy, které je možné vytvářet podle věku, a to na třídy věkově homogenní a na třídy věkově heterogenní \textcolor{red}{(viz. Tabulka~\ref{tab:rozdeleniTridCR})}. Do mateřských škol je možné zařazovat i děti se specifickými potřebami a vytvářet tak třídy integrované. 		
